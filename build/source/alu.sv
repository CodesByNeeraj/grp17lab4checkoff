...
module alu #(
    ...
    localparam _MP_SIZE_59496571 = SIZE;
    logic [(_MP_SIZE_59496571)-1:0] M_adder_a;
    logic [(_MP_SIZE_59496571)-1:0] M_adder_b;
    logic [5:0] M_adder_alufn_signal;
    logic [(_MP_SIZE_59496571)-1:0] M_adder_out;
    logic M_adder_z;
    logic M_adder_v;
    logic M_adder_n;
    
    adder #(
        .SIZE(_MP_SIZE_59496571)
    ) adder (
        .a(M_adder_a),
        .b(M_adder_b),
    ...
    localparam _MP_SIZE_150771118 = 6'h20;
